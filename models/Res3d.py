...
class M3DFEL_I3D(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.features = create_resnet(input_channel=3,model_depth=50,norm=nn.BatchNorm3d,activation=nn.ReLU)
        model_state_dict = torch.load('D:\M3DFEL\\resnet50_3d_weights11.pth')
        # # 将本地参数加载到模型中True
        try:
...
# Define the model arguments class for initialization (adjust as needed)
class Args:
